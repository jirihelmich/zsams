...
<?php
			...
			echo '<tr><th>jahoor</th><td></td></tr>';
							...
							<tr>
								...
								<td style="max-width:210px;">
									<?php if ( wppa_extended_access() ) { ?>
										<select id="wppa-parsel" style="max-width:100%;" onchange="wppaAjaxUpdateAlbum(<?php echo $edit_id ?>, 'a_parent', this)" ><?php echo wppa_album_select_a(array('checkaccess' => true, 'exclude' => $albuminfo['id'], 'selected' => $albuminfo['a_parent'], 'addselected' => true, 'addnone' => true, 'addseparate' => true, 'disableancestors' => true, 'path' => wppa_switch( 'hier_albsel'))) ?></select>
									<?php } else { ?>
										<select id="wppa-parsel" style="max-width:100%;" onchange="wppaAjaxUpdateAlbum(<?php echo $edit_id ?>, 'a_parent', this)" ><?php echo wppa_album_select_a(array('checkaccess' => true, 'exclude' => $albuminfo['id'], 'selected' => $albuminfo['a_parent'], 'addselected' => true, 'disableancestors' => true, 'path' => wppa_switch( 'hier_albsel'))) ?></select>
									<?php } ?>
								</td>
								<td>
							...
							<?php if ( ! wppa_switch( 'alt_is_restricted') || current_user_can('administrator') ) { ?>
							<tr>
								<th>
							...
							<!-- Cover type -->
							<?php if ( ! wppa_switch( 'covertype_is_restricted') || current_user_can('administrator') ) { ?>
							<tr>
								<th>
							...
							<?php if ( wppa_switch( 'apply_newphoto_desc') ) {
